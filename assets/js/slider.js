{var flkty = new Flickity('.results__box', {
  prevNextButtons: false,
  pageDots: false,
  wrapAround: true,
  on: {
    dragStart() {
      resultsBox.removeEventListener('click', nextSlide, false);
    },
    change() {
    ...
    settle() {
      resultsBox.addEventListener('click', nextSlide, false);
    },
    scroll(progress) {
...
var resultsBox = document.querySelector('.results__wrapper');
resultsBox.addEventListener('click', nextSlide, false);
